...
if (f != "") {
 var h = f;
        ...
        for (i = 0; i < b.length; i++) {
            ...
            foot = "<div class='eo2As '><section class='ltpMr Slqrh'><span class='fr66n'><a href='/?v=" + id + "&l=" + h + "' title='" + alt + "'><button class='dCJp8 afkep'><span aria-label='Komentari' class='glyphsSpriteComment__outline__24__grey_9 u-__7'></span></button></a></span><span class='_15y0l'><button class='dCJp8 afkep'><span aria-label='Bagikan Postingan' class='glyphsSpriteShare__outline__24__grey_9 u-__7'></span></button></span><!--glyphsSpriteSave__outline__24__grey_9 --><span class='wmtNn'><a href='/?v=" + id + "&l=" + h + "' rel='noindex'><button class='dCJp8 afkep'><span aria-label='Simpan' class=' u-__7'><svg height='24px' width='24px' x='0px' y='0px' viewBox='0 0 512 512' style='enable-background:new 0 0 512 512;' xml:space='preserve'><g><g><path d='M382.56,233.376C379.968,227.648,374.272,224,368,224h-64V16c0-8.832-7.168-16-16-16h-64c-8.832,0-16,7.168-16,16v208h-64c-6.272,0-11.968,3.68-14.56,9.376c-2.624,5.728-1.6,12.416,2.528,17.152l112,128c3.04,3.488,7.424,5.472,12.032,5.472c4.608,0,8.992-2.016,12.032-5.472l112-128C384.192,245.824,385.152,239.104,382.56,233.376z'/></g></g><g><g><path d='M432,352v96H80v-96H16v128c0,17.696,14.336,32,32,32h416c17.696,0,32-14.304,32-32V352H432z'/></g></g></svg></span></button></a></span></section><section class='EDfFK ygqzn'><div class='HbPOm _9Ytll'><span class='vcOH2' role='button' tabindex='0'><span>" + view + "</span> " + viewer + "</span></div></section></div>";

            if (type == "Gambar") {
                x += "<article class='_8Rm4L M9sTE  L_LMM SgTZ1   ePUX4'><a href='/?v=" + id + "&l=" + h + "'><div class='_97aPb '><div role='button' tabindex='0' class='ZyFrc'><div class='eLAPa kPFhm'><div class='KL4Bh' style='padding-bottom: " + padding + "%;'><img alt='" + alt + "' class='FFVAD lazy' src='" + b[i].node.display_url + "' style='object-fit: cover;' width='" + width + "' height='" + height + "'></div></div></div></div>" + foot + "</a></article>";
            } else {
                x += "<article class='_8Rm4L M9sTE  L_LMM SgTZ1   ePUX4'><div class='_97aPb '><div><div class='kPFhm B1JlO OAXCp ' style='padding-bottom: calc(" + padding + "% - 1px);'><div class='oJub8'><div class='GRtmf wymO0 '><div class='_5wCQW'><img alt='" + alt + "' class='_8jZFn' src='" + b[i].node.display_url + "' width='" + width + "' height='" + height + "'></div></div><div class='oujXn'><div class='y4vpg VXgpI'><span aria-label='Video' class='mediatypesSpriteVideo__filled__32 u-__7'></span></div><a href='/?v=" + id + "&l=" + h + "' title='Video lucu di dagelan online'><span class='B2xwy _3G0Ji PTIMp videoSpritePlayButton' role='button'><span class='jNBsH'>Putar</span></span></a></div></div></div></div></div>" + foot + "</article>";
            }
